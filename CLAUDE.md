...
This project is indexed by GitNexus as **bizdev-email-agent** (493 symbols, 1029 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
