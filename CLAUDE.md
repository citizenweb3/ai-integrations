...
This project is indexed by GitNexus as **bizdev-email-agent** (625 symbols, 1421 relationships, 42 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
