...
This project is indexed by GitNexus as **bizdev-email-agent** (467 symbols, 963 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
