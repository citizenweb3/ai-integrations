...
This project is indexed by GitNexus as **bizdev-email-agent** (517 symbols, 1104 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
