...
This project is indexed by GitNexus as **bizdev-email-agent** (473 symbols, 980 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
