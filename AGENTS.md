...
This project is indexed by GitNexus as **bizdev-email-agent** (513 symbols, 1088 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
