...
This project is indexed by GitNexus as **bizdev-email-agent** (637 symbols, 1469 relationships, 43 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
