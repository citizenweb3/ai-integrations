...
This project is indexed by GitNexus as **bizdev-email-agent** (639 symbols, 1472 relationships, 43 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
