...
This project is indexed by GitNexus as **bizdev-email-agent** (665 symbols, 1543 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
