...
This project is indexed by GitNexus as **bizdev-email-agent** (643 symbols, 1477 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
