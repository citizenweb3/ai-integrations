...
This project is indexed by GitNexus as **bizdev-email-agent** (653 symbols, 1509 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
